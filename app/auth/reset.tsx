...
const styles = StyleSheet.create({
  ...
  successTitle: { fontFamily: Typography.bold.fontFamily, fontSize: Typography.sizes.xl, color: Colors.nearBlack },
  ...
  backToLoginText: { fontFamily: Typography.semiBold.fontFamily, fontSize: Typography.sizes.base, color: Colors.white },
});
